...
export default function Sostenibilita() {
  return (
    <main>
      <ProdottoIntro
        rows={[{ text: 'SOSTENIBILITÀ' }]}
        align="left"
        subtitle="Energie rinnovabili, gestione idrica intelligente, emissioni zero"
        subtitleNoWrap
        body={[
      ...
      <SectionZigzag
        title="Magazzino a emissioni zero"
        image={{ src: '/images/sostenibilita.jpg' }}
      ...
      >
        ...
        <p><strong className={styles.subheading}>Filiera a basso impatto</strong></p>
